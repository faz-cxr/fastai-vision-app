...
model_file_url = 'https://drive.google.com/uc?export=download&id=1pBAi2RJyR-nymlcyv0Jah5f3SCp2YP4f'
...
async def setup_learner():
    ...
    data_bunch = ImageDataBunch.single_from_classes(path, classes, ds_tfms
=get_transforms(), size=150).normalize(imagenet_stats)
